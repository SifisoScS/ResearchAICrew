...
print("Imported signal and werkzeug modules")
...
def index():
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            return render_template('result.html', report_html=report_html, plot_path=plot_path)
        except Exception as e:
            error_html = markdown.markdown(f"**Error**: {str(e)}")
            print(f"Error occurred: {str(e)}")
            return render_template('result.html', report_html=error_html, plot_path=None)
